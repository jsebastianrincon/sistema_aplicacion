    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="tables">
          ...
          <!-- Modal -->
          <a type="button" class="btn btn-success" href="listar_paises"><i class="fa fa-list"></i>
            Listar Paises</a>

          <div class="bs-example widget-shadow" data-example-id="hoverable-table">
            <h4>Cargar Paises</h4>
            
            <button type="button" class="btn btn-warning"><a download="plantillaregistropaises.csv" href="importacion/importar_paises/plantillaregistropaises.csv"><font color="white"><i class="fa fa-download"></i> Descargar Plantilla</font></a></button>
