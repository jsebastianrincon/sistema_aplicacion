        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="tables">
                    ...
                    <a type="button" class="btn btn-success" href="listar_paises"><i
                            class="fa fa-list"></i> Listar Paises Activos</a>
                    ...
                    <div class="bs-example widget-shadow" data-example-id="hoverable-table">
                        <h4>Lista de Paises Inactivos</h4>
                        <div class="buscar">
                        ...
                        <table class="table table-hover" id="dataTable">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $consulta_paises = $mysqli->query("SELECT * FROM paises WHERE estado = 0 ORDER BY identificador");
                                    while($extraer_paises = $consulta_paises->fetch_array()){
                                    ?>
                                <td>
                                    <?php echo $extraer_paises['identificador'];?>
                                </td>
                                <td>
                                    <?php echo $extraer_paises['nombre_pais'];?>
                                </td>
                                <td>
                                    ...
                                    <div class="button-container">
                                        <form action="controller/paises/controller.php" method="POST">
                                            ...
                                            <button type="submit" name="activar_pais" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Activar</button>
                                        </form>
